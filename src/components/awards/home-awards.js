...
import styles from './home-awards.scss'
...
const HomeAwards = () => {
    return (
        ...
        <div id="premios" className="home_awards-container awards">
            <Container>
                <Row>
                   <Col  xs={12} >
            ...
            <Container>
                <Tabs variant='pills'  defaultActiveKey="home" id="uncontrolled-tab-example">
                    <Tab eventKey="home" title="Individual">
                        <div id="primer-puesto">
                            <Row className="awards__container"  >
                                    ...
                                    <div className="d-flex flex-column justify-content-center col-xs-12 col-lg-6">
                                        <h2 className="g-subtitle text-yellow-h2">1º Puesto:</h2>
                                        <h2 className="g-subtitle  text-purple mg-top-0 mb-3 "> Viaje y Tour a Silicon Valley </h2>
                    ...
                    <Tab eventKey="profile" title="Grupal">
                        <div  className="home_awards-container position-relative" >
                            <div className="position-relative">
                                <div className="row">
                                    {/*<!-- Mejor Grupo -->*/}
                                    <div className="col-xs-12 col-lg-6  d-flex flex-column justify-content-center">
                                    ...
                                    <div className="col-xs-12 col-lg-6 text-center mg-top-60">
