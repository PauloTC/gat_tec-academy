                ...
                <Row>
                   <Col  xs={12} >
                        <h2 className="text-purple">
                            <img alt="trofeo" src={prizes} /> <br /> Premios </h2>
            ...
            <Container>
                <Tabs variant='pills' defaultActiveKey="home" id="uncontrolled-tab-example">
                                ...
                                <div className="container">
                                    <div className="row">
                                        ...
                                        <div className="col-xs-12 col-lg-6">
                                            ...
                                            <h2 className="text-purple mg-top-0"> Viaje y Tour a Silicon Valley </h2>
                    ...
                    <Tab eventKey="profile" title="Grupal">
                        <div className="tab-pane fade" id="pills-grupal" role="tabpanel" aria-labelledby="pills-grupal-tab">
                            <div className="container position-relative">
                                <div className="row">
                                    {/*<!-- Mejor Grupo -->*/}
                                    <div className="col-xs-12 col-lg-6">
                                        <h2 className="text-yellow mg-bottom-0">Premio al Mejor Grupo:</h2>
