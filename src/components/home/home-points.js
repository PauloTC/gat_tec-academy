    ...
    <div id="ganar-puntos" className="container-fluid page-section">
      <div className="container">
        ...
        <div className="row">
          <div
            id="personales"
            className="offset-md-1 col-md-5 offset-sm-1 col-sm-10"
          >
          ...
          <div
            id="grupales"
            className="offset-md-0 col-md-5 offset-sm-1 col-sm-10"
          >
            <div className="header">
            ...
            <div className="box-puntos">
              ...
              <p className="font-size-14">
                ...
                partir de lo aprendido en los cursos que ayude a Belcorp
              </p>
            </div>
          </div>
        </div>
